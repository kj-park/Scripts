...
#region define functions
    ...
    function Get-StatusLog {
        ...
        $EventLog = $null; $EventLog = Get-WinEvent -FilterHashtable @{ LogName="Microsoft-Windows-DeviceManagement-Enterprise-Diagnostics-Provider/Operational"; Id=4027 } -MaxEvents $MaxEvents -ErrorAction SilentlyContinue
        if ( $null -ne $EventLog ) {
